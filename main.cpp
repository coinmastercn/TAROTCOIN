...
// Copyright (c) 2013 The TAROTCOIN developers
...
uint256 hashGenesisBlock("0x00000950de8e5c87d8773ccf931c7876b2ea8a069fd09bd39df212a16264db8e");
static const unsigned int timeGenesisBlock = 1467280207;
...
const string strMessageMagic = "TAROTCOIN Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "TAROTCOIN create 06.22";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x4a136ec26b229dcba34e8483176180eebff1bd71c772dbfa14ec5afafe31fdd8"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("TAROTCOINMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("TAROTCOINMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("TAROTCOINMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("TAROTCOIN-miner");
    ...
    try { loop {
        ...
        printf("Running TAROTCOINMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("TAROTCOINMiner terminated\n");
        throw;
    }
}
