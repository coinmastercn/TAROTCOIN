...
const QString BITCOIN_IPC_PREFIX("TAROTCOIN:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click TAROTCOIN: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start TAROTCOIN: click-to-pay handler");
    else
...
{
    // clicking on TAROTCOIN: URLs creates FileOpen events on the Mac:
